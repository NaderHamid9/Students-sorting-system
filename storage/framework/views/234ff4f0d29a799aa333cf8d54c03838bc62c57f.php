<?php $__env->startSection('content'); ?>
    ...
    <a style="text-decoration: none; color: black"  href="<?php echo e(route('dep.index')); ?>"><h1 class="mt-5"><?php echo e($item->department_name); ?></h1></a>
    ...
    <table class="table table-striped text-center students-table">
        ...
        <th >
            <?php $__currentLoopData = $department; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e(route('student.create' , $item->id)); ?>">
        ...
        <?php $__currentLoopData = $student; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <tr>
                ...
                <td><a href="<?php echo e(route('student.edit' , $item->id)); ?>" class="edit-btn"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#g8g8g8" class="bi bi-pencil-square" viewBox="0 0 16 16">
                            <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
                            <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
                        </svg></a></td>
                <td> <a href="<?php echo e(route('student.delete' , $item->id)); ?>" class="delete-btn">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Nader\students\resources\views/single.blade.php ENDPATH**/ ?>